...
<body class="grid">
    <div class="container" style="margin-bottom: 250px; margin-left: 12px;">
        ...
        <button type="button" class="btn btn-primary" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('edit', null, null, true); ?>').load();">Create Customer</button>
